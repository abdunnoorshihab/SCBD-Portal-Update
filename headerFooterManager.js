class SpecialHeader extends HTMLElement {
    connectedCallback() {
        ...
        .active {
          ...
          /* Example background color when active */
          color: #1d4ed8;
          /* Example text color when active */
        }
      </style>
      ...
      <header class="bg-white text-black flex items-center justify-between p-4 shadow-md sticky top-0">
        ...
        <nav class="hidden lg:flex space-x-4 justify-center">
          ...
          <!-- Home Link -->
          <a href="index.html" class="menu-item text-black hover:bg-blue-500 rounded-md font-semibold text-sm m-auto">Home</a>
  
          <!-- Forms & Templates Dropdown -->
          <div class="relative inline-block">
            <a href="#" class="menu-item text-black hover:bg-blue-500 rounded-md font-semibold text-sm mx-4">Forms &
              Templates <i class="fa fa-caret-down ml-2"></i></a>
            <div class="dropdown-content absolute hidden group-hover:block bg-white shadow-lg rounded-md w-40 mt-2">
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">All</a>
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">BA Manual</a>
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">Communication</a>
            </div>
          </div>
  
          <!-- IT Help Desk Dropdown -->
          <div class="relative inline-block">
            <a href="#" class="menu-item text-black hover:bg-blue-500 rounded-md font-semibold text-sm mx-4">IT Help
              Desk <i class="fa fa-caret-down ml-2"></i></a>
            <div class="dropdown-content absolute hidden group-hover:block bg-white shadow-lg rounded-md w-40 mt-2">
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">Requisition</a>
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">Tutorial</a>
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">IT Helpline</a>
            </div>
          </div>
  
          <!-- Gender Equality Dropdown -->
          <div class="relative inline-block">
            <a href="#" class="menu-item text-black hover:bg-blue-500 rounded-md font-semibold text-sm mx-4">Gender
              Equality <i class="fa fa-caret-down ml-2"></i></a>
            <div class="dropdown-content absolute hidden group-hover:block bg-white shadow-lg rounded-md w-40 mt-2">
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">Policies</a>
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">E-learning Course</a>
            </div>
          </div>
          ...
          <div class="relative inline-block">
            <a href="#"
              class="menu-item text-black hover:bg-blue-500 rounded-md font-semibold text-sm mx-4">Miscellaneous <i
                class="fa fa-caret-down ml-2"></i></a>
            <div class="dropdown-content absolute hidden group-hover:block bg-white shadow-lg rounded-md w-40 mt-2">
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">Guidelines</a>
              <a href="#" class="block px-4 py-2 text-black hover:bg-gray-200">Knowledge Sharing</a>
            </div>
          </div>
  
          <!-- Additional Links -->
          <a href="staff-list.html" class="menu-item text-black hover:bg-blue-500 rounded-md font-semibold text-sm m-auto">Staff
            Lists</a>
          <a href="vendor-list.html" class="menu-item text-black hover:bg-blue-500 rounded-md font-semibold text-sm m-auto">Vendor
            Lists</a>
            
        </nav>
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="63.917" viewBox="0 0 250 63.917">
      ...
      <!-- Mobile Menu -->
      <nav
        class="mobile-menu fixed top-16 left-0 w-full bg-gray-800 text-white flex flex-col p-4 space-y-2 lg:hidden hidden sticky top-0"
        id="mobile-menu">
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">Dashboard</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">Forms</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">Templates</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">IT Requisitions</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">Vendor Lists</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">Staff Lists</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">IT Tutorials</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">Knowledge Sharing</a>
        <a href="#" class="hover:bg-gray-700 px-3 py-2 rounded">IT Guidelines</a>
      </nav>
            </header>
        `;
    }
