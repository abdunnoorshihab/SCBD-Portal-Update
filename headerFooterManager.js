        ...
        <div class="sidenav">
            ...
            <div class="middlenav">
                <div class="menu-items" id="menuItems">
                    ...
                    <div class="dropdown">
                        <a href="forms.html" class="dropbtn">Forms & Templates <i class="fas fa-caret-down"></i></a>
                        <div class="dropdown-content">
                            <a href="forms.html">All Forms</a>
                            <a href="forms.html">Communications</a>
                            <a href="forms.html">BA Manual</a>
                        </div>
                    </div>
                    <div class="dropdown">
